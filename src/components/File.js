...
const File = ({ data, onClick }) => {
  ...
  return (
    ...
    //   </div>
    // </a>
    <div className="card folderLayputCardImage-col" onClick={onClickResource}>
  ...
  <div className="_x8ede33 file-name" data-id="re_single_download_action">
  ...
  <div className="_secondaryText_jnfj5l">
    <div>
      <span className="_labelText_hq5slr">File Format:</span> Video (mov)
    </div>
    <div>
      <span className="_labelText_hq5slr">File Size:</span> 176.83 MB
    </div>
  </div>
  ...
  <div className="_indicators_lp6zce">
    <div className="_indicatorRow_5kaapu">
          <a className="_linkColours_crf4gc">
            <button
              className="_iconButton_10fc6mf" type="button">
                <span
                  className="material-icons _icon_77bp8u ">
                 <Public/>
                </span>
            </button>
          </a>
  ...
  <div className="" style={{ paddingRight: 24 }}>
    <div className="_container_1892uua ">
      <a className="_linkColours_icon">
        <button
          className="_iconButton_10fc6mfw"
          type="button">
            <span
              className="material-icons _icon_77bp8u " >
              <FileDownloadIcon />
